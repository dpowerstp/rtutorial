### purpose: this script goes through more of the essentials around types of data and data structures, before getting into conditionality and creating functions
### date: 07/20/2022
